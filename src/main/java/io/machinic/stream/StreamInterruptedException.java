...
public class StreamInterruptedException extends StreamException {
	
	public StreamInterruptedException(InterruptedException cause) {
		super("Stream operation interrupted", cause);
	}
